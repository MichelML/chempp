...
UserService::createUser(const oatpp::Object<UserDto> &dto) {
...
oatpp::Object<UserDto>
UserService::updateUser(const oatpp::Object<UserDto> &dto) {
...
UserService::getAllUsers(const oatpp::UInt32 &offset,
...
UserService::deleteUserById(const oatpp::String &userId) {
